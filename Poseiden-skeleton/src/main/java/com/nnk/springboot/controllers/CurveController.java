...
private CurvePointRepository curvePointRepository;
    ...
    public String showUpdateForm(@PathVariable("id") Integer id, Model model) {
		...
		/*
		 * CurvePoint curvePoint= curvePointdervice.getCurvePointById(id);
		 */
    ...
    public String deleteBid(@PathVariable("id") Integer id, Model model) {
    	...
    	CurvePoint curvePointTodelede=curvePointRepository.findById(id).orElseThrow(() -> new IllegalArgumentException("Invalid curvePoint Id:" + id));
